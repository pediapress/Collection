...
$messages['en'] = array(
    ...
    'coll-add_article' => 'Add article',
    'coll-remove_article' => 'Remove article',
    ...
    'coll-articles' => 'articles',
    'coll-download_as_pdf' => 'Download as PDF',
    'coll-noscript_text' => '<noscript><h1>JavaScript is Required!</h1><strong>Your browser does not support JavaScript or JavaScript has been turned off. This page will not work correctly, unless JavaScript is enabled.</strong></noscript>',
    'coll-intro_text' => "You can collect articles, generate and download a PDF file from article collections and save article collections for later use or to share them.\n\nSee [[Help:Collections]] for more information about collections.",
    'coll-pdftoobigcat' => 'The category contains more than %PARAM% articles, only the first %PARAM% articles can be added to your collection. Do you want to add them?',
    'coll-my_collection' => 'My Collection',
    'coll-download_title' => 'Download Collection as PDF',
    'coll-download_text' => 'To download an automatically generated PDF file of your article collection, click the button.',
    ...
    'coll-sort_alphabetically' => 'Sort articles alphabetically',
    ...
    'coll-mwzip_error_title' => 'Could not generate article collection',
    'coll-mwzip_error_msg' => 'An error occured during generation of article collection.',
    'coll-notitle_title' => 'Could not get article title',
    'coll-notitle_title' => 'The title of the article could not be determined.',
    ...
    'coll-overwrite_text' => 'A page with the name $title already exists. Do you want it to be replaced with your collection?',
    'coll-yes' => 'Yes',
    'coll-no' => 'No',
    'coll-load_overwrite_text' => 'You already have some articles in your collection. Do want to overwrite your current collection, append the new content or cancel?',
    'coll-overwrite' => 'Overwrite',
    'coll-append' => 'Append',
    'coll-cancel' => 'Cancel',
    'coll-limit_exceeded_title' => 'Collection Too Big',
    'coll-limit_exceeded_text' => 'Your article collection is too big. No more articles can be added.',
    'coll-generating_pdf_title' => 'Generating PDF',
    'coll-generating_pdf_text' => "'''Please wait while the PDF file is being generated.''' This page should automatically refresh every few seconds, if this does not work, please press refresh button of your browser.",
    'coll-pdf_finished_title' => 'PDF Generation Complete',
    'coll-pdf_finished_text' => "The PDF file has been generated. Click on the link below to download it to your computer.",
    ...
    'coll-articles_removed' => 'The following articles could not be rendered and were removed from the PDF file:',
);
?>
