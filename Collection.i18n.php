...
هذه الصفحة لن تعمل بطريقة صحيحة، إلا إذا تم تفعيل الجافاسكريبت.</strong>',
	...
	'coll-save_collection_text' => 'لحفظ المجموعة للاستخدام المستقبلى، اختار نوع مجموعة ودخل عنوان صفحة:',
...
$messages['zh-hans'] = array(
	...
	'coll-book_creator_intro' => "<big>在''图书模式''，您可以建立一个内含您自己选择之维基页面的图书。你可以将其汇出成不同的格式(例如PDF或是ODF)或者订做实体书。",
	'coll-book_creator_help' => '请参阅[[{{MediaWiki:Coll-helppage}}|说明页面]]以取得更多资讯。',
	'coll-start_book_creator' => '启动图书模式',
	'coll-book_creator_text_article' => '{{MediaWiki:Coll-helppage}}/图书模式文字',
	'coll-collection' => '图书',
	'coll-collections' => '图书',
	...
	'coll-couldnotaddarticle_msg' => '无法新增此页面。',
	'coll-couldnotremovearticle_title' => '无法删除维基页面',
	'coll-couldnotremovearticle_msg' => '无法删除此页面。',
