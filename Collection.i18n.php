...
$messages['en'] = array(
	'coll-desc' => '[[Special:Collection|Collect articles]], generate PDFs',
...
See [[Help:Collections]] for more information about collections.",
	'coll-pdftoobigcat' => 'The category contains more than %PARAM% articles, only the first %PARAM% articles can be added to your collection.
...
Do you want it to be replaced with your collection?',
	'coll-yes' => 'Yes',
	'coll-no' => 'No',
	'coll-load_overwrite_text' => 'You already have some articles in your collection.
Do want to overwrite your current collection, append the new content or cancel?',
	...
	'coll-limit_exceeded_text' => 'Your article collection is too big.
No more articles can be added.',
