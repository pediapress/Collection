...
This page will not work correctly, unless JavaScript is enabled.</strong>',
	...
	'coll-save_category'              => 'Collections are saved in the [[:Category:{{int:Coll-collections}}|Category:{{int:Coll-collections}}]].',
...
דף זה לא יעבוד כדרוש, אלא אם כן JavaScript יופעל.</strong>',
	...
	'coll-save_category' => 'אוספים נשמרים בקטגוריה [[:Category:{{MediaWiki:Coll-collections}}|אוספים]].',
