...
JavaScript ғәмәлдә булмаған саҡта был бит дөрөҫ эшләмәйәсәк.</strong>',
	...
	'coll-save_collection_title' => 'Китапты һаҡларға һәм уны ҡулланырға рөхсәт итеү',
...
Уны һеҙҙең китабығыҙға алыштырылыуын теләйһегеҙме?',
	'coll-yes' => 'Эйе',
	'coll-no' => 'Юҡ',
...
Һеҙ ағымдағы китапты яңынан яҙҙырырға, яңы эстәлек өҫтәргә йәки был китапты тейәүҙе кире алырға теләйһегеҙме?',
	...
	'coll-limit_exceeded_title' => 'Бигерәк ҙур китап',
	'coll-limit_exceeded_text' => 'Һеҙҙең китабығыҙ бигерәк ҙур.
Уға бөтән биттәр өҫтәп булмай.',
